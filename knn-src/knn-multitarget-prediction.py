...
# CONFIGURATION
MODEL_NAME = 'kneighborsregressor_multitarget'
...
def main():
    ...
    predicted_stresses, predicted_strains = predict_stress_strain(knn_model, validation_data)
    ...
    plot_filename = os.path.join(REPORTS_DIR, "knn_multitarget_hold_out_validation_curve.png")
    ...
    results_filename = os.path.join(REPORTS_DIR, "knn_multitarget_actual_vs_predicted.csv")
