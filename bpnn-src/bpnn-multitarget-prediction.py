...
def main():
    ...
    predicted_stresses, predicted_strains = predict_stress_strain(bpnn_model, validation_data)
    ...
    plot_filename = os.path.join(REPORTS_DIR, "bpnn_multitarget_hold_out_validation_curve.png")
    ...
    results_filename = os.path.join(REPORTS_DIR, "bpnn_multitarget_actual_vs_predicted.csv")
